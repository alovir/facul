...
const char* serverName = "http://192.168.1.11/tcc/esp/esp-post-data.php";

//Mantenha este valor da chave API para ser compatível com o código PHP
...
//Coloque aqui o nome do sensor ou modelo
String sensorName = "BME280";

//Adicione aqui a localização do monitoramento
